    ...
    <div>
      <div class="tree-table-demo">
        ...
        <div class="tree-container">
          ...
          <el-tree :data="treeData" :default-expanded-keys="[0]" node-key="materialTypeId" :props="treeProps"
                   @node-click="handleTreeNodeClick"></el-tree>
        </div>
        <!--      添加、编辑材料类型对话框-->
        <el-dialog title="新建/编辑材料类型" v-model="isModalVisibleType" style="width: 400px;height: 200px">
        ...
        <div class="table-container">
          ...
          <!-- 表格内容-->
          <el-table :data="tableData" style="width: 900px" border stripe @selection-change="handleSelectionChange"
                    :show-selection="true">
            ...
            <el-table-column label="状态" prop="materialStatus" :filters="[{text:'启用',value:1},{text: '停用',value: 0}]"
          ...
          <!--添加材料对话框-->
          <el-dialog title="添加原材料" v-model="isModalVisible">
            <el-form :model="formData" label-width="80px">
              ...
              <el-form-item label="类别" prop="materialType">
                <el-tree-select v-model="formDataType" :data="treeData" :props="{
                    children: 'children',
              ...
              <el-form-item label="备注" prop="materialRemark">
                <el-input type="textarea" v-model="formData.materialRemark"></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer">
